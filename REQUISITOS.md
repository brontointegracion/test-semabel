...
**The visitor's filters are remembered, not asked twice.** Province and sport both persist. Someone who follows basketball in Chiriquí opens the app to basketball in Chiriquí, not to a chooser. Everything the visitor picks about what they want to see is stored the same way and survives closing the app.
